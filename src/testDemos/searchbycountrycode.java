...
public class searchbycountrycode extends JFrame {
	...
	public void init() {
		...
		btnNewButton.setIcon(new ImageIcon(searchbycountrycode.class.getResource("/com/sun/javafx/scene/web/skin/Undo_16x16_JFX.png")));
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(txtSearchCountryCode, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblCountryCode)
						.addComponent(txtSearchCountryCode, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnCodeSearch))
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Country Code", "Country Name", "Population", "Region"
			}
		));
	...
	private ArrayList<Country> getCountries() {
		...
		try {
			...
			statement2 = connection.prepareStatement(SqlCommand.getLikeCodeSql(txtSearchCountryCode.getText()));
